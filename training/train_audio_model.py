...
# Configuration
DATASET_ROOT = os.path.join(PROJECT_ROOT, "dataset/audio")  # Assuming structure: dataset/audio/happy/*.wav
MODEL_PATH = os.path.join(PROJECT_ROOT, "models/rf_audio.pkl")
